...
export const borderUtils = [
  ...
  },
  {
    ...
    utilityClasses: [
      ...
      { classSuffix: "full", classValues: ["border-bottom-left-radius: 100%;"], },
  ...
  },
  {
    ...
    utilityClasses: [
      ...
      { classSuffix: "full", classValues: ["border-bottom-right-radius: 100%;"], },
      { classSuffix: "half", classValues: ["border-bottom-right-radius: 50%;"], },
    ],
  },
  {
    classPrefix: "rad-tl-",
