...
export const boxModelUtils = [
  ...
  },
  {
    ...
    utilityClasses: [
      ...
      { classSuffix: "1/1", classValues: ["height: 100dvh;", "width: 100dvh;"], },
      { classSuffix: "1/2", classValues: ["height: 50dvh;", "width: 50dvh;"] },
      { classSuffix: "auto", classValues: ["height: auto;", "width: auto;"] },
      { classSuffix: "fc", classValues: ["height: fit-content;", "width: fit-content;"], },
      { classSuffix: "full", classValues: ["height: 100%;", "width: 100%;"] },
      { classSuffix: "half", classValues: ["height: 50%;", "width: 50%;"] },
      { classSuffix: "max", classValues: ["height: max-content;", "width: max-content"], },
      { classSuffix: "min", classValues: ["height: min-content;", "width: min-content;"], },
    ],
  },
  {
    classPrefix: "max-dim-",
  ...
  },
  {
    ...
    utilityClasses: [
      ...generateClass(["margin-left", "margin-right"], 100, 0.25, { unit: "rem", }),
      { classSuffix: "auto", classValues: ["margin-left: auto;", "margin-right: auto;"], },
    ],
  },
  {
    classPrefix: "my-",
    ...
    utilityClasses: [
      ...generateClass(["margin-bottom", "margin-top"], 100, 0.25, { unit: "rem", }),
      { classSuffix: "auto", classValues: ["margin-bottom: auto;", "margin-top: auto;"], },
    ],
  },
  {
    classPrefix: "p-",
  ...
  },
  {
    ...
    utilityClasses: [
      ...generateClass(["padding-left", "padding-right"], 100, 0.25, { unit: "rem", }),
      { classSuffix: "auto", classValues: ["padding-left: auto;", "padding-right: auto;"], },
    ],
  },
  {
    classPrefix: "py-",
    ...
    utilityClasses: [
      ...generateClass(["padding-bottom", "padding-top"], 100, 0.25, { unit: "rem", }),
      { classSuffix: "auto", classValues: ["padding-bottom: auto;", "padding-top: auto;"], },
    ],
  },
  {
    classPrefix: "s-x-",
  ...
  },
  {
    ...
    utilityClasses: [
      ...generateClass(["margin-top", "margin-bottom"], 100, 0.25, { unit: "rem", }),
      { classSuffix: "auto", classValues: ["margin-top: auto;", "margin-bottom: auto;"], },
    ],
  },
  {
    classPrefix: "w-",
